...
// Sarah's Day — the original scripted walkthrough. FROZEN: the beats below are
// what the presenter has rehearsed; shared visual upgrades may change how they
// look, but the sequence itself must not change.
//
// Engine types (Step, PressBeat, Segment) live in ./types and are shared with
// the All-Hands story in ./allHands.
export type { Step, Segment, PressBeat, SarahEmotion } from "./types";
